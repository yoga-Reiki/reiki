...
import RequestPopup from '../../courses/RequestPopup'
import { Link, useParams } from 'react-router-dom';
import productDetail1 from "../../../assets/img/productDetail1.png"
    ...
    return (
        <div className='py-9 sm:py-14 md:py-16 px-4 xl:px-0 text-[#464646]'>
            <div className="flex items-center space-x-2 text-gray-500 pb-8">
                <Link to="/product" className='hover:text-[#EA7913]'>Products</Link>
                <MdArrowForwardIos size={12} />
                <Link className='text-[#EA7913] font-semibold'>{productid}</Link>
            </div>
            <div className="flex flex-col lg:flex-row justify-between gap-7 xl:gap-12 items-start w-full">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-between h-full md:min-h-[450px] lg:min-h-[744px]">
                    <div>
                        ...
                        <p className='text-2xl font-Raleway Raleway-bold pt-4 pb-2'>Benefits</p>
                        <ul className="list-disc pl-5 text-[#656565]">
                            <li>Amplifies energy during healing and meditation sessions</li>
                            <li>Cleanses aura and removes negative energy</li>
                            <li>Supports emotional balance, stress relief & deeper sleep</li>
                            <li>Enhances intuition and connection to higher self</li>
                            <li>Acts as a protective shield against toxic environments</li>
                        </ul>

                        <p className='text-2xl font-Raleway Raleway-bold pt-6 pb-2'>Specifications</p>
                        <div className='space-y-2'>
                            <div><span className='font-semibold'>Material: </span><span className='text-[#656565]'>Natural crystal beads (8mm)</span></div>
                            <div><span className='font-semibold'>Fit: </span><span className='text-[#656565]'>Stretchable (one size fits all)</span></div>
                            <div><span className='font-semibold'>Beads Count: </span><span className='text-[#656565]'> ~21–24 beads</span></div>
                            <div><span className='font-semibold'>Gender: </span><span className='text-[#656565]'>Unisex</span></div>
                            <div><span className='font-semibold'>Handmade in India </span></div>
                        </div>
                    ...
                    <div className='flex justify-between items-center pt-6'>
                        <div className="flex items-center gap-2">
                            <span className="text-lg md:text-[32px] md:leading-[40px] font-Raleway text-[#292929]">$79</span>
